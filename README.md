...
- For the "cat" utility it is specified by IEEE Std 1003.1-2024 that there is a "-u" option, this is ignored in this implementation since there is already no delay or a very minimal delay between file reading and printing.
